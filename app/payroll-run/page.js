                  ...
                  <div style={{padding:'16px 20px',display:'grid',gridTemplateColumns:'1fr 1fr',gap:20}}>
                    <div>
                      ...
                      {isHourly ? (<>
                        ...
                        {Number(line.ot2_hours||0)>0&&<div style={{display:'flex',justifyContent:'space-between',fontSize:12,marginBottom:4,color:'#dc2626'}}><span>Rest/Holiday Hours ({line.ot2_hours}h)</span><span>AED {Number(line.ot2_pay||0).toLocaleString(undefined,{minimumFractionDigits:2})}</span></div>}
                      </>) : (<>
