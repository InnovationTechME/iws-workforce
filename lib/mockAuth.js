...
export const canAccess = (module) => {
  ...
  const role = getRole()
  const operationsOnly = ['dashboard','workers','timesheets','attendance','payroll-run','pending-approvals']
  const accountsModules = ['dashboard','payroll','payroll-run','payroll-settings','pending-approvals','reports']
