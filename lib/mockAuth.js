...
export const canAccess = (module) => {
  ...
  const role = getRole()
  const operationsOnly = ['dashboard','setup','reports','workers','suppliers','timesheets','attendance','payroll-run','pending-approvals','instructions','delivery-log','workflow-map']
  const accountsModules = ['dashboard','setup','reports','records','suppliers','payroll','payroll-run','payroll-settings','pending-approvals','instructions','delivery-log','workflow-map']
