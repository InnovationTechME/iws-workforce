// Round C: direct-staff templates restructured per CLAUDE.md §5.3.1.
// Contract-worker and subcontractor templates unchanged.
const DOC_TEMPLATES = {
  direct_staff_permanent: [
    { doc_type: 'offer_letter',           label: 'Offer Letter (signed)',           is_blocking: false, in_pack: false, track_expiry: false },
    { doc_type: 'passport_copy',          label: 'Passport Copy',                   is_blocking: true,  in_pack: true,  track_expiry: true,  kind: 'passport_copy' },
    { doc_type: 'passport_photo',         label: 'Passport Photo',                  is_blocking: true,  in_pack: true,  track_expiry: false, kind: 'passport_photo' },
    { doc_type: 'medical_fitness',        label: 'Medical Fitness',                 is_blocking: true,  in_pack: false, track_expiry: false, kind: 'toggle' },
    { doc_type: 'emirates_id',            label: 'Emirates ID',                     is_blocking: true,  in_pack: true,  track_expiry: true,  kind: 'emirates_id' },
    { doc_type: 'uae_visa',               label: 'UAE Visa',                        is_blocking: true,  in_pack: true,  track_expiry: true,  kind: 'uae_visa' },
    { doc_type: 'labour_card',            label: 'IT Labour Card / MOHRE',          is_blocking: false, in_pack: false, track_expiry: true,  kind: 'labour_card', warning: true },
    { doc_type: 'health_insurance',       label: 'Health Insurance',                is_blocking: true,  in_pack: false, track_expiry: true,  kind: 'health_insurance' },
    { doc_type: 'workmen_compensation',   label: "Workmen's Compensation (WC)",     is_blocking: true,  in_pack: true,  track_expiry: true,  kind: 'workmen_compensation', requires_highlight: true },
  ...
  direct_staff_office: [
    ...
    { doc_type: 'labour_card',            label: 'IT Labour Card / MOHRE',          is_blocking: false, in_pack: false, track_expiry: true,  kind: 'labour_card', warning: true },
    { doc_type: 'health_insurance',       label: 'Health Insurance',                is_blocking: true,  in_pack: false, track_expiry: true,  kind: 'health_insurance' },
    { doc_type: 'workmen_compensation',   label: "Workmen's Compensation (WC)",     is_blocking: false, in_pack: false, track_expiry: true,  kind: 'workmen_compensation', requires_highlight: true },
    { doc_type: 'employment_contract',    label: 'Employment Contract',             is_blocking: false, in_pack: false, track_expiry: false },
    { doc_type: 'iloe_certificate',       label: 'ILOE Certificate',                is_blocking: false, in_pack: false, track_expiry: true  },
    { doc_type: 'worker_policy_manual',   label: 'Worker Policy Manual',            is_blocking: false, in_pack: false, track_expiry: false },
  ],
  contract_worker: [
    { doc_type: 'passport_copy',          label: 'Passport Copy',                   is_blocking: true,  in_pack: true,  track_expiry: true,  kind: 'passport_copy' },
    { doc_type: 'emirates_id',            label: 'ID Copy (Emirates ID)',           is_blocking: true,  in_pack: true,  track_expiry: true,  kind: 'emirates_id' },
    { doc_type: 'workmen_compensation',   label: "Workmen's Compensation (WC)",     is_blocking: true,  in_pack: true,  track_expiry: true,  kind: 'workmen_compensation', requires_highlight: true },
    { doc_type: 'uae_visa',               label: 'Passport Visa Copy',              is_blocking: true,  in_pack: true,  track_expiry: true,  kind: 'uae_visa' },
  ],
